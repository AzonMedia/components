...
trait ComponentTrait
{
    ...
    public static function get_name() : string
    {
        ...
        if (!defined($called_class.'::COMPONENT_NAME')) {
            throw new \RuntimeException(sprintf('The class/component %1$s does not define the COMPONENT_NAME constant.', $called_class));
        }
    ...
    public static function get_url() : string
    {
        ...
        if (!defined($called_class.'::COMPONENT_URL')) {
            throw new \RuntimeException(sprintf('The class/component %1$s does not define the COMPONENT_URL constant.', $called_class));
        }
    ...
    public static function get_namespace() : string
    {
        ...
        if (!defined($called_class.'::COMPONENT_NAMESPACE')) {
            throw new \RuntimeException(sprintf('The class/component %1$s does not define the COMPONENT_NAMESPACE constant.', $called_class));
        }
    ...
    public static function get_version() : string
    {
        ...
        if (!defined($called_class.'::COMPONENT_VERSION')) {
            throw new \RuntimeException(sprintf('The class/component %1$s does not define the COMPONENT_VERSION constant.', $called_class));
        }
    ...
    public static function get_vendor_name() : string
    {
        ...
        if (!defined($called_class.'::VENDOR_NAME')) {
            throw new \RuntimeException(sprintf('The class/component %1$s does not define the VENDOR_NAME constant.', $called_class));
        }
    ...
    public static function get_vendor_url() : string
    {
        ...
        if (!defined($called_class.'::VENDOR_URL')) {
            throw new \RuntimeException(sprintf('The class/component %1$s does not define the VENDOR_URL constant.', $called_class));
        }
    ...
    public static function get_error_reference_url() : string
    {
        ...
        if (!defined($called_class.'::ERROR_REFERENCE_URL')) {
            throw new \RuntimeException(sprintf('The class/component %1$s does not define the ERROR_REFERENCE_URL constant.', $called_class));
        }
    ...
    private static function get_composer_json_object(string $composer_file) : object
    {
        ...
        if ($json === NULL) {
            ...
            throw new \RuntimeException(sprintf('The %1$s contains invalid json: %2$s.', $composer_file, json_last_error_msg() ) );
        }
        return $json;
    }
}